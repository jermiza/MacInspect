...
#ifndef MACINSPECT_SWIFT_H
#define MACINSPECT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MacInspect",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface FullscreenWindowController : NSObject <NSWindowDelegate>
...
@class NSEvent;
@class NSCoder;
SWIFT_CLASS("_TtC10MacInspect14KeyViewWrapper")
@interface KeyViewWrapper : NSView
...
@interface TrackpadMouseTrackingView : NSView
